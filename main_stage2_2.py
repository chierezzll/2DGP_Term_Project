...
def enter():
    ...
    air_tile4 = Air_tile(600, 500, 10)

    air_tile5 = Air_tile(900, 600, 7)
    air_tile6 = Air_tile(1100, 500, 10)

    air_tile7 = Air_tile(1400, 400, 5)
    air_tile8 = Air_tile(1550, 500, 7)

    air_tile9 = Air_tile(1750, 620, 15)
