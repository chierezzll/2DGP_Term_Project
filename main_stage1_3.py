...
def enter():
    ...
    server.coins = Coins(950, 470, 3)
    server.coins2 = Coins(1190, 270, 2)
    server.item_block1 = Item_Block(300, 310, 1)
    server.item_block2 = Item_Block(380, 310, 1)
    server.item_block3 = Item_Block(460, 310, 1)
    server.item_block4 = Item_Block(380, 430, 1)
    server.item_block5 = Item_Block(1200, 420, 2)
